<template>
  <div
    class="flex flex-1 flex-col md:flex-row-reverse px-8 py-4 w-full max-w-screen-xl m-auto"
  >
    <div
      class="flex flex-1 flex-col justify-center items-center md:items-start space-y-12"
    >
